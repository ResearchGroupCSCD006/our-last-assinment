...
\hline
\textbf{No.}& \textbf{Student Name} & \textbf{RegNo} & \textbf{Student No.} \\ \hline
\textit{1}&\textbf{KAMUKAMA DARIET} & \textit{16/U/5346/PS}& \textit{} \\ \hline
\textit{2}&\textbf{NYONYINTONO ISAAC PITWA }& \textit{16/U/10672/PS}& \textit{} \\ \hline
\textit{3}&\textbf{BAMWIREKU PRISCA} & \textit{16/U/18716} & \textit{} \\ \hline
\textit{4}&\textbf{NABIMANYA LYNN}& \textit{16/U/8105/EVE}  & \textit{} \\ \hline
\textit{6}&\textbf{ } & \  & \textit{} \\ 
 \hline
\end{tabular}}
